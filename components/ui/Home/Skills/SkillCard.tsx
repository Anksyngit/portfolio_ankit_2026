...
const SkillCard = ({ icon: Icon, name }: Props) => {
  return (
    <div className='group relative bg-white dark:bg-purple-950 shadow-md rounded-xl p-4 flex flex-col item-center gap-3 cursor-pointer gap-3 cursor-pointer hover:scale-105 transition-all duration-300'>
